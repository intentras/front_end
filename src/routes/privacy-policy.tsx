...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Intentras" },
      {
        name: "description",
        content: "How Intentras collects, uses, and protects your data.",
      },
    ],
  }),
...
const entities = [
  {
    region: "Sri Lanka",
    legalName: "intentras.com (Pvt) Ltd",
    address: "No. 12, Union Place, Colombo 02",
    phone: "+94 70 142 2342",
    phoneHref: "tel:+94701422342",
  },
  {
    region: "USA",
    legalName: "intentras.com Inc.",
    address: "741 Riverside Drive, Forest Hills, NY 11375",
    phone: "+1 332 242 3073",
    phoneHref: "tel:+13322423073",
  },
];
...
function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-5 pt-32 pb-24 sm:px-8">
        ...
        <div className="legal-content mt-10">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Privacy Policy) refers to intentras.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Country/State</strong> refers to: New York, United States.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              ...
              <p>
                We use "Personal Data" and "Personal Information" interchangeably unless a law uses
                a specific term.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to intentras, accessible from{" "}
                <a href="https://intentras.com/" rel="external nofollow noopener" target="_blank">
                  https://intentras.com/
                </a>
                .
              </p>
          ...
          <ul>
            ...
            <li>
              ...
              visited those pages and for other related website statistics (for example, recording
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                ...
                the Website and record the consent choices You have made, so that We can honor those
                choices on future visits.
              </p>
            </li>
            <li>
              <p>
              ...
              <p>
                ...
                Website, such as remembering Your Account login details or language preference. The
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                You have already purchased or inquired about. We send such marketing communications
                only where permitted by applicable law: where prior consent is required (for
                example, under the laws applicable in the EEA and the UK), We will send them only
                with Your consent; otherwise, We may send them until You opt out. You may opt out or
                withdraw Your consent at any time by using the unsubscribe link in any marketing
            ...
            <li>
              <p>
                ...
                Our promotional campaigns, and evaluating and improving Our Service, products,
          ...
          <ul>
            <li>
              ...
              Providers to monitor and analyze the use of Our Service, and to contact You.
            </li>
            <li>
            ...
            <li>
              ...
              information may be viewed by all users and may be publicly distributed outside the
              Service.
            </li>
            <li>
          ...
          <p>
            ...
            periods below are maximum periods ("up to") and We may delete or anonymize data sooner
            when it is no longer needed for the relevant purpose. We apply different retention
          ...
          <p>
            ...
            located. This means that this information may be transferred to — and maintained on —
          ...
          <p>
            Under certain circumstances, the Company may disclose Your Personal Data if required to
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                scroll, browse, and pay attention on websites. The service is operated by Mouseflow
                ApS.
              </p>
          ...
          <ul>
            <li>
              <p>By email: contact@intentras.com</p>
            </li>
            <li>
              <p>
                By visiting this page on Our Website:{" "}
                <a
                  href="https://intentras.com/#contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://intentras.com/#contact
                </a>
              </p>
            </li>
            <li>
              <p>By phone: +13322423073</p>
            </li>
            <li>
              <p>By mail: 741 Riverside Drive Forest Hills, NY 11375</p>
            </li>
          </ul>
        </div>
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2">
            {entities.map((e) => (
              <div key={e.region}>
                ...
                <p className="mt-2 text-sm font-medium text-foreground">{e.legalName}</p>
