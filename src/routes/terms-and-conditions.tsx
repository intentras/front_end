...
export const Route = createFileRoute("/terms-and-conditions")({
  head: () => ({
    meta: [
      { title: "Terms and Conditions — Intentras" },
      {
        name: "description",
        content: "The terms and conditions governing use of the Intentras service.",
      },
    ],
  }),
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content" className="mx-auto max-w-3xl px-5 pt-32 pb-24 sm:px-8">
        ...
        <h1 className="mt-4 text-3xl font-bold sm:text-4xl">Terms and Conditions</h1>
        ...
        <div className="legal-content mt-10">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in these Terms and Conditions) refers to intentras.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                Terms and Conditions, including any documents expressly incorporated by reference,
                which govern Your access to and use of the Service and form the entire agreement
                between You and the Company regarding the Service.
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            You acknowledge and agree that the Company shall not be responsible or liable, directly
            or indirectly, for any damage or loss caused or alleged to be caused by or in connection
            with Your access to or use of any Third-Party Social Media Service, including any
            content, goods, or services made available through them. Your use of any Third-Party
            Social Media Service is governed by that Third-Party Social Media Service's terms and
            privacy policies.
          </p>
